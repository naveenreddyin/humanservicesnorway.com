...
( function( $ ) {
	...
	wp.customize( 'featured_image3_title', function( value ) {
		value.bind( function( to ) {
			$( '.slide3-header' ).text( to );
		} );
	} );
	...
	wp.customize( 'slide3_button1_text', function( value ) {
		value.bind( function( to ) {
                    if( to == '' ) {
                        $( '.slide3_button1' ).hide();
                    }else{
			...
			$( '.slide3_button1' ).text( to );
		} );
	} );
	wp.customize( 'slide3_button2_text', function( value ) {
		value.bind( function( to ) {
                    if( to == '' ) {
                        $( '.slide3_button2' ).hide();
                    }else{
	...
	wp.customize( 'header_font', function( value ) {
		value.bind( function( to ) {
                    ...
                    $('h1,h2,h3,h4,h5,h6,.slide2-header,.slide1-header,.slide3-header,.athena-title, .widget-title,.entry-title, .product_title').css({
                        'font-family': to
                    });
...
//                }
        ...
        wp.customize( 'featured_image3' , function( value ) {
